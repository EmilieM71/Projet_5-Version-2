...
CREATE TABLE food (
                ...
                palm_oil VARCHAR(20),
                allergen TEXT,
                energy_100g VARCHAR(20),
                energy VARCHAR(20),
                fat_100g VARCHAR(20),
                saturated_fat_100g VARCHAR(20),
                carbohydrates_100g VARCHAR(20),
                sugars_100g VARCHAR(20),
                proteins_100g VARCHAR(20),
                salt_100g VARCHAR(20),
                sodium_100g VARCHAR(20),
